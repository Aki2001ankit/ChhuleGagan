...
function Course() {
  ...
  const HandleBuy = () => {
    if (user === undefined || user === null) {
      toast({
        title: "First login to buy this course",
        status: "error",
        duration: 5000,
        isClosable: true,
      });
      navigate("/login");
        ...
        toast({
            title: "Scan the QR for payment to buy this course",
            status: "success",
            duration: 5000,
            isClosable: true,
          });
        ...
        <div class="col-md-12 content-7">
          <div class="row g-0 border rounded-5 overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
            <div class="col p-4 d-flex flex-column position-static">
              <strong class="d-inline-block mb-2 text-primary fs-3">
                English Speaking Course
              </strong>
              <h3 class="mb-0">Course Details</h3>
              <div class="mb-1 text-muted justify-content-around">
                New Batch Starting from DD/MM/YYYY{" "}
              </div>
              <p class="card-text fs-4 align-self-start">
                1. Speak English with experts
              </p>
              <p class="card-text fs-4 align-self-start">
                2. Enhance correct English pronunciation{" "}
              </p>
              <p class="card-text fs-4 align-self-start">
                3. Live interaction class individually{" "}
              </p>
              <p class="card-text fs-4 align-self-start">
                4. Group discussions
              </p>
              ...
              <p class="card-text fs-4 align-self-start">
                7. Monday to Friday 30 min class (Regular teaching individually)
              </p>
              <p class="card-text fs-4 align-self-start">
                8. Saturday 60-90 min class (Group discussion)
              </p>
              <br /> <br />
              <h3 class="mb-0 text-secondary">
                MRP: Rs <s>1199/month</s>
              </h3>
